...
j.system.platform.kvm.initPhysicalBridges(pubinterface="<pubinterface_name_on_host>")
...
import JumpScale.lib.kvm
j.system.platform.kvm.create('test-ubuntu', 'ubuntu1404')

where ‘test-ubuntu’ is your VM name, and ‘ubuntu1404’ is the image name
args (j.system.platform.kvm.create(self, name, baseimage, replace=True, description='', size=10, memory=512, cpu_count=1)):
